...
import geoCoord from './mapData';
import { analyzeAreaAction } from '../actions/analyze';
...
class Map extends Component {
  ...
  componentDidMount() {
    this.props.dispatch(analyzeAreaAction());
  }
...
function mapStateToProps({ analyzeArea: { datas } }) {
